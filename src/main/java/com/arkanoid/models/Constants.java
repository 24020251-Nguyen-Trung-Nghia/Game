...
public class Constants {
    ...
    public static final String PROPERTIES_FILE_NAME = "arkanoid.properties";
    public static final String HIGHSCORE_KEY = "highscore";
    public static final String BALL_SPEED_KEY = "ball_speed";
    public static final String BONUS_BLOCK_SPEED_KEY = "bonus_block_speed";
    public static final String ENEMY_SPEED_KEY = "enemy_speed";
    public static final String UNLOCKED_LEVEL_KEY  = "unlocked_level";
