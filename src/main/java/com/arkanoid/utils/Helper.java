...
public class Helper {
    ...
    public static double computeLineIntersectionX(final double x1, final double y1, final double x2, final double y2, final double x3, final double y3, final double x4, final double y4) {
        return computeLineIntersection(x1, y1, x2, y2, x3, y3, x4, y4, true);
    }

    public static double computeLineIntersectionY(final double x1, final double y1, final double x2, final double y2, final double x3, final double y3, final double x4, final double y4) {
    ...
    public static double distance(final double x0, final double y0, final double x1, final double y1) {
