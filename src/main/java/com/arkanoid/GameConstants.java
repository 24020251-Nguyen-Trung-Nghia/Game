...
public class GameConstants {
    ...
    public static final double ENEMY_HEIGHT = 32;
    public static final double EXPLOSION_WIDTH = 32;
    public static final double EXPLOSION_HEIGHT = 32;
    public static final double BALL_VX_INFLUENCE = 0.75;
    ...
    public static final double BALL_SPEED;
    public static final double BONUS_BLOCK_SPEED;
    public static final double ENEMY_SPEED;
    public static final Color SCORE_WHITE;
    public final static Bounds[] BORDER_BOUNDS;
